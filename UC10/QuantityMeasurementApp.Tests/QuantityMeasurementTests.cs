...
namespace QuantityMeasurementApp.Tests
{
    ...
    //Test Volume Unit for scalability verification
    ...
    //Volume measurement implementation for Testing scalability
    public class VolumeMeasurementImpl : IMeasurable
    {
        ...
        public double GetConversionFactor()
        {
            switch (unit)
            {
                case VolumeUnit.Liter: return 1.0;
                case VolumeUnit.Milliliter: return 0.001;
    ...
    public class QuantityMeasurementTests
    {
        ...
        {
            Quantity<IMeasurable> liter = new Quantity<IMeasurable>(1.0, new VolumeMeasurementImpl(VolumeUnit.Liter));

            Quantity<IMeasurable> ml = new Quantity<IMeasurable>(1000.0, new VolumeMeasurementImpl(VolumeUnit.Milliliter));
        ...
        {
            Quantity<IMeasurable> volume = new Quantity<IMeasurable>(1.0, new VolumeMeasurementImpl(VolumeUnit.Liter));
