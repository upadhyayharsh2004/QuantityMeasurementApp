...
namespace QuantityMeasurementApp
{
    ...
    // Handles conversion logic and arithmetic capability for length units
    public class LengthMeasurementImpl : IMeasurable
    {
        // Stores the specific length unit (Feet, Inch, Yard, Centimeter)
        ...
        // For length measurements, all arithmetic operations are allowed
