...
namespace QuantityMeasurementApp
{
    public class QuantityMeasurementApp
    {
        public static void Main(string[] args)
        {
            ...
            Console.WriteLine("19. Check Temperature Equality");
            Console.WriteLine("20. Convert Temperature");
            Console.WriteLine("21. Try Temperature Arithmetic");
            ...
            switch (choice)
            {
                ...
                case 19:
                    ...
                    TemperatureUnit tu1 = (TemperatureUnit)Enum.Parse(typeof(TemperatureUnit), Console.ReadLine(), true);
                    ...
                    TemperatureUnit tu2 = (TemperatureUnit)Enum.Parse(typeof(TemperatureUnit), Console.ReadLine(), true);

                    //Create Instances
                    Quantity<IMeasurable> temp1 = new Quantity<IMeasurable>(t1, new TemperatureMeasurementImpl(tu1));
                    Quantity<IMeasurable> temp2 = new Quantity<IMeasurable>(t2, new TemperatureMeasurementImpl(tu2));

                    DemonstrateTemperatureEquality(temp1, temp2);
                    break;
                ...
                case 20:
                    ...
                    //Take From Unit
                    Console.Write("Enter From Unit (Celsius/Fahrenheit/Kelvin): ");
                    TemperatureUnit fromT = (TemperatureUnit)Enum.Parse(typeof(TemperatureUnit), Console.ReadLine(), true);

                    //Take Target Unit
                    Console.Write("Enter To Unit (Celsius/Fahrenheit/Kelvin): ");
                    TemperatureUnit toT = (TemperatureUnit)Enum.Parse(typeof(TemperatureUnit), Console.ReadLine(), true);

                    DemonstrateTemperatureConversion(tempValue, fromT, toT);
                    break;
                ...
                case 21:
                    try
                    {
                        Quantity<IMeasurable> tempA = new Quantity<IMeasurable>(100, new TemperatureMeasurementImpl(TemperatureUnit.Celsius));
                        Quantity<IMeasurable> tempB = new Quantity<IMeasurable>(50, new TemperatureMeasurementImpl(TemperatureUnit.Celsius));

                        Quantity<IMeasurable> result = tempA.Add(tempB);
        ...
        public static void DemonstrateTemperatureEquality(Quantity<IMeasurable> first, Quantity<IMeasurable> second)
        {
            Console.WriteLine(first.Equals(second)
        ...
        {
            Quantity<IMeasurable> temp = new Quantity<IMeasurable>(value, new TemperatureMeasurementImpl(from));

            Quantity<IMeasurable> converted = temp.ConvertTo(new TemperatureMeasurementImpl(to));

            Console.WriteLine($"{temp} = {converted}");
        }
    }
}