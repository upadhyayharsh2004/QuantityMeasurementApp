...
{
    // Implementation of IMeasurable for weight measurements
    // Handles unit conversion and arithmetic support for weight units
    public class WeightMeasurementImpl : IMeasurable
    {
        // Stores the selected weight unit (Kilogram, Gram, Pound)
        ...
        // Validates arithmetic operations for weight measurements
        // No restriction: all arithmetic operations are supported
